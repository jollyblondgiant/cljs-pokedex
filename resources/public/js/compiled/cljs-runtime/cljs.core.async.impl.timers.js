...
var i_32568 = (0);
while(true){
if((i_32568 < arr.length)){
(arr[i_32568] = null);

var G__32573 = (i_32568 + (1));
i_32568 = G__32573;
continue;
} else {
}
...
var i_32609 = (self__.level + (1));
while(true){
if((i_32609 <= (new_level + (1)))){
(update[i_32609] = self__.header);

var G__32615 = (i_32609 + (1));
i_32609 = G__32615;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32621 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32621[i]));
} else {
x__$2.forward.push((((i < links_32621.length))?(links_32621[i]):null));
}

if((i < links_32621.length)){
(links_32621[i] = x__$2);
} else {
links_32621.push(x__$2);
}
...
var i_32624 = (0);
while(true){
if((i_32624 <= self__.level)){
var links_32625 = (update[i_32624]).forward;
if((x__$1 === (((i_32624 < links_32625.length))?(links_32625[i_32624]):null))){
(links_32625[i_32624] = (x__$1.forward[i_32624]));

var G__32626 = (i_32624 + (1));
i_32624 = G__32626;
continue;
} else {
var G__32627 = (i_32624 + (1));
i_32624 = G__32627;
continue;
}
} else {
...
var G__32639 = nx;
var G__32640 = (level__$1 - (1));
x = G__32639;
level__$1 = G__32640;
continue;
} else {
var G__32642 = x;
var G__32643 = (level__$1 - (1));
x = G__32642;
level__$1 = G__32643;
continue;
}
