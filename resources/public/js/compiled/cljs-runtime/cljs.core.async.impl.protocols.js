...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30532 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30532(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30534 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30534(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30536 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30536(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30537 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30537(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30538 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30538(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30539 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30539(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30544 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30544(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30549 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30549(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30556 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30556(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30560 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30560(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30568 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30568(b);
}
});
