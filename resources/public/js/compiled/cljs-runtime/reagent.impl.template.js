...
var G__37648 = o;
goog.object.set(G__37648,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37736__delegate = function (args){
...
return G__37736__delegate.call(this,args);};
...
return G__37736__delegate(args);
});
...
var G__37650 = o;
goog.object.set(G__37650,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37739__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37740__i < G__37740__a.length) {G__37740__a[G__37740__i] = arguments[G__37740__i + 0]; ++G__37740__i;}
  args = new cljs.core.IndexedSeq(G__37740__a,0,null);
} 
return G__37739__delegate.call(this,args);};
G__37739.cljs$lang$maxFixedArity = 0;
G__37739.cljs$lang$applyTo = (function (arglist__37741){
var args = cljs.core.seq(arglist__37741);
return G__37739__delegate(args);
});
...
var G__37656 = props;
var G__37656__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37656,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37656);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37656__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37658 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37658,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37658;
}
})(),id_class);
...
var G__37660 = (cljs.core.count(argv) - first_child);
switch (G__37660) {
case (0):
...
var vec__37662 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37662,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37662,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37662,(2),null);
...
var temp__5757__auto___37745 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37745 == null)){
} else {
var key_37747 = temp__5757__auto___37745;
(jsprops.key = key_37747);
}
...
var temp__5757__auto___37748 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37748 == null)){
} else {
var key_37749 = temp__5757__auto___37748;
(jsprops.key = key_37749);
}
...
var temp__5757__auto___37750 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___37750 == null)){
} else {
var key_37751 = temp__5757__auto___37750;
(jsprops.key = key_37751);
}
...
var temp__5757__auto___37764 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37764 == null)){
} else {
var key_37765 = temp__5757__auto___37764;
(jsprops.key = key_37765);
}
...
var temp__5757__auto___37766 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37766 == null)){
} else {
var key_37767 = temp__5757__auto___37766;
(jsprops.key = key_37767);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37687_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37687_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37699 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37699,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37699,(1),null);
...
break;
default:
var G__37779 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37780 = compiler;
v = G__37779;
compiler = G__37780;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37719 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37719 = (function (opts,id,fn_to_element,parse_fn,meta37720){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37719.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37721,meta37720__$1){
var self__ = this;
var _37721__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37719(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37720__$1));
}));

(reagent.impl.template.t_reagent$impl$template37719.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37721){
var self__ = this;
var _37721__$1 = this;
return self__.meta37720;
}));

(reagent.impl.template.t_reagent$impl$template37719.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37719.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37719.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37719.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37719.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37719.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37720","meta37720",1723397637,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37719.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37719.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37719");

(reagent.impl.template.t_reagent$impl$template37719.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template37719");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37719.
 */
reagent.impl.template.__GT_t_reagent$impl$template37719 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37719(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37720){
return (new reagent.impl.template.t_reagent$impl$template37719(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37720));
});

}

return (new reagent.impl.template.t_reagent$impl$template37719(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
