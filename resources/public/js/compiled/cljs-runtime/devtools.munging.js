...
var o26962 = temp__5751__auto__;
var temp__5751__auto____$1 = (o26962["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o26963 = temp__5751__auto____$1;
return (o26963["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26429__auto__ = f;
return (o__26429__auto__["toString"]).call(o__26429__auto__);
} else {
return "";
}
}catch (e26978){var _ = e26978;
return "";
}});
...
try{var o__26429__auto___27499 = t;
(o__26429__auto___27499["cljs$lang$ctorPrWriter"]).call(o__26429__auto___27499,t,writer);
}catch (e26993){var __27503 = e26993;
}
...
var char_code = (function (){var o__26429__auto__ = (new String(char$));
return (o__26429__auto__["charCodeAt"]).call(o__26429__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26429__auto__ = String;
return (o__26429__auto__["fromCharCode"]).call(o__26429__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27040 = num_code;
switch (G__27040) {
case (1):
return (185);
...
var o__26429__auto__ = String;
return (o__26429__auto__["fromCharCode"]).call(o__26429__auto__,superscript_code);
});
/**
...
}catch (e27104){var _e__26450__auto__ = e27104;
return false;
}})())){
...
var vec__27111 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27111,(0),null);
...
var len__4818__auto___27516 = arguments.length;
var i__4819__auto___27518 = (0);
while(true){
if((i__4819__auto___27518 < len__4818__auto___27516)){
args__4824__auto__.push((arguments[i__4819__auto___27518]));

var G__27521 = (i__4819__auto___27518 + (1));
i__4819__auto___27518 = G__27521;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27193){
var vec__27194 = p__27193;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27194,(0),null);
...
var G__27524 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27525 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27524;
remaining_tokens = G__27525;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27177){
var G__27178 = cljs.core.first(seq27177);
var seq27177__$1 = cljs.core.next(seq27177);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27178,seq27177__$1);
}));
...
var vec__27230 = cljs.core.split_with((function (p1__27226_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27226_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27230,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27230,(1),null);
...
var vec__27259 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27259,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27259,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27534 = cljs.core.rest(remaining_tokens);
var G__27535 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27534;
name_tokens = G__27535;
continue;
} else {
...
var vec__27276 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27276,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27276,(1),null);
var vec__27279 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27279,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27279,(1),null);
var vec__27282 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27282,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27282,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27282,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27282,(3),null);
...
var vec__27292 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27292,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27292,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27292,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27292,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27292,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27292,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27310 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27310,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27310,(1),null);
var vec__27313 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27313,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27313,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27328 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27328) : devtools.munging.parse_fn_info_deep.call(null,G__27328));
})()));
}
} else {
return fn_info;
...
var G__27551 = (arity + (1));
var G__27552 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27344){
var vec__27345 = p__27344;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27345,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27345,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27366_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27366_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27368_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27368_SHARP_);
}),sorted_infos);
...
var args__4824__auto__ = [];
var len__4818__auto___27560 = arguments.length;
var i__4819__auto___27562 = (0);
while(true){
if((i__4819__auto___27562 < len__4818__auto___27560)){
args__4824__auto__.push((arguments[i__4819__auto___27562]));

var G__27563 = (i__4819__auto___27562 + (1));
i__4819__auto___27562 = G__27563;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27380){
var vec__27382 = p__27380;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27382,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27374){
...
var map__27402 = options;
var map__27402__$1 = cljs.core.__destructure_map(map__27402);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27402__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27402__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27402__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27402__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27403 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27403,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27403,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27403,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27403,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27403,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27403,(5),null);
...
var o__26429__auto__ = f;
return (o__26429__auto__["getBasis"]).call(o__26429__auto__);
});
/**
...
}catch (e27412){var _e__26450__auto__ = e27412;
...
var G__27573 = (obj[cljs.core.first(path)]);
var G__27574 = cljs.core.rest(path);
obj = G__27573;
path = G__27574;
continue;
} else {
...
var _STAR_ = (function (accum,p__27467){
var vec__27468 = p__27467;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27468,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27468,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27479){
var vec__27480 = p__27479;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27480,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27480,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27480,(2),null);
...
var post_process = (function (p__27493){
var vec__27494 = p__27493;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27494,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27494,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27489_SHARP_){
return (obj[cljs.core.first(p1__27489_SHARP_)]);
}),sorted_matches);
