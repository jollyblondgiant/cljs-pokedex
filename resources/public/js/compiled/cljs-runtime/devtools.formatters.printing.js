...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27565){
var G__27566 = cljs.core.first(seq27565);
var seq27565__$1 = cljs.core.next(seq27565);
var G__27568 = cljs.core.first(seq27565__$1);
var seq27565__$2 = cljs.core.next(seq27565__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27566,G__27568,seq27565__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27579_SHARP_){
return (!((cljs.core.meta(p1__27579_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27586__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27587){var _e__26450__auto__ = e27587;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e27590){var _e__26450__auto__ = e27590;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27596 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27597 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27597);

try{var map__27598 = opts;
var map__27598__$1 = cljs.core.__destructure_map(map__27598);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27598__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27596);
}});
...
var temp__5751__auto___27638 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___27638)){
var managed_print_level_27639 = temp__5751__auto___27638;
var _STAR_print_level_STAR__orig_val__27600_27640 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27601_27641 = managed_print_level_27639;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27601_27641);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27599_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27599_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27600_27640);
}} else {
job_fn();
}
